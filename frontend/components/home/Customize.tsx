    ...
    return(
        <section className={styles['customize']}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 202" fill="none">
                <path d="M513.279 85.9761C206.14 -5.04855 -0.523941 85.9761 -0.523941 85.9761L-0.523936 201.999L1920 202V0.662148C1920 207.162 1466 61 1150.41 85.9761C834.829 110.952 820.418 177.001 513.279 85.9761Z"/>
            </svg>
